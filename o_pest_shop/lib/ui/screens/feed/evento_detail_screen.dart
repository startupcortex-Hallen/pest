...
class EventoDetailScreen extends StatefulWidget {
  final String postId;
  const EventoDetailScreen({super.key, required this.postId});
...
class _EventoDetailScreenState extends State<EventoDetailScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      debugPrint('Erro evento detail: $e');
    }
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text('Evento', style: Theme.of(context).textTheme.labelMedium?.copyWith(color: AppColors.primary, fontWeight: FontWeight.w600)),
                            ],
                          ),
